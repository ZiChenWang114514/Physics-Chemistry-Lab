...
# Define equation
equation = [x.strip() for x in 'q_c = 10**18 / (gamma_infinity * N_A + 100 * (c * N_A)**(2/3))'.split('=')]

# Define variable


variable = [
    ('N_A = 6.02214076e23 +- 0', 'N_A'),
    ('gamma_infinity = 5.11 +- 0.12', '\\gamma_{\\infty}'),
    ('c = 0.5 +- 0', 'c'),
