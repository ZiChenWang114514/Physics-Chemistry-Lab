...
variable = [
    ('m1 = 3.853 +- 0.0008', '\\Delta m_{\\ce{\\textit{n}-BuOH}}'),
    ('m2 = 3.856 +- 0.0008', '\\Delta m_{\\ce{\\textit{n}-BuOH}}^\\prime'),
    ('m3 = 4.791 +- 0.0008', '\\Delta m_{\\ce{H_2O}}'),
    ('m4 = 4.792 +- 0.0008', '\\Delta m_{\\ce{H_2O}}^\\prime'),
    ('r = 0.9980 +- 0', '\\rho_{\\ce{H_2O}}'),
]
