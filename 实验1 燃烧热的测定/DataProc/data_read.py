...
name_1 = '20230921121310combustiondata.csv'
name_2 = '20230921142539dissolutiondata.csv'
name_3 = '20230921154902combustiondata.csv'
...
adjust(name_1)
print('adjust(name_1) done')
adjust(name_2)
print('adjust(name_2) done')
adjust(name_3)
print('adjust(name_3) done')
...
transfer(name_1[:-4] + '_adjusted.csv')
print('transfer(name_1[:-4] + _adjusted.csv) done')
transfer(name_2[:-4] + '_adjusted.csv')
print('transfer(name_2[:-4] + _adjusted.csv) done')
transfer(name_3[:-4] + '_adjusted.csv')
